...
function myMap2CallBack(num) {
    return num - 1
}

const map2 = map1.map(myMap2CallBack)
// console.log(map2)
...
let map5 = map4.map((obj) => {
    let newObj = obj
    newObj.name = 'Presedent ' + newObj.name
    return newObj
})
...
let newArr2 = arrNum.filter((num, index) => num % 2 !== 0 && index % 2 !== 0)
// console.log(newArr2)
...
let myVar55 = reduce1.reduce((a, c) => a + c)
